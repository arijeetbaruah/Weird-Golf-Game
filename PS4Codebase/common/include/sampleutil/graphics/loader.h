	...
	namespace SampleUtil
	{
		namespace Graphics
		{
			...
			public:
				...
				/*!
				 * @~English
				 * @brief Create read/write enabled texture
				 * @details This generates a read/write enabled texture. To delete the generated instance, use sce::SampleUtil::destroy().
				 * @param outTexture Pointer to which the generated texture is returned
				 * @param texFormat Format of a texture
				 * @param width Width of a texture
				 * @param height Height of a texture
